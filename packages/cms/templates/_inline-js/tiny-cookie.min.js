!(function (e, t) {
	...
	function e(t, n, o) {
		return void 0 === n
			? e.get(t)
			: void (null === n ? e.remove(t) : e.set(t, n, o))
	}
	function t(e) {
		return e.replace(/[.*+?^$|[\](){}\\-]/g, '\\$&')
	}
	...
	function o(e) {
		...
		switch (n) {
			...
			case 'h':
				...
				break
			case 'm':
				t.setMinutes(t.getMinutes() + o)
				break
			case 's':
				t.setSeconds(t.getSeconds() + o)
				break
			default:
				t = new Date(e)
		}
	...
	return (
		...
		(e.set = function (e, t, o, r) {
			o !== !0 && ((r = o), (o = !1)), (r = n(r ? r : {}))
			var u = e + '=' + (o ? t : encodeURIComponent(t)) + r
			document.cookie = u
		}),
		(e.setRaw = function (t, n, o) {
			e.set(t, n, !0, o)
		}),
		(e.remove = function (t) {
